...
$sqla = "SELECT did,count FROM mf_cart_detail WHERE cartId=$cid AND productId=$pid";
$result = mysqli_query($conn,$sqla);
$row = mysqli_fetch_assoc($result);

//$output['productCount'] = $row;
if($row){   //之前曾经购买过该商品，则购买数量+1
  ...
  $output['code'] = 1;
  $output['msg'] = 'update ok';
  
  
  
}else {     //之前从未购买过该商品，则添加购买记录，购买数量为1
  $count = 1;
  $sql = "INSERT INTO mf_cart_detail VALUES(NULL,$cid, $pid, $count,$uid)";
